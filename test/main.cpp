...
std::string json_str = "{\"slice\":[[{\"key\":0,\"role\":0,\"host\":\"127.0.0.1\",\"port\":6379,\"pwd\":\"\",\"conn_timeout\":10,\"min_conn_count\":20,\"max_conn_count\":100},{\"key\":0,\"role\":1,\"host\":\"127.0.0.1\",\"port\":6379,\"pwd\":\"\",\"conn_timeout\":10,\"min_conn_count\":20,\"max_conn_count\":100}],[{\"key\":1,\"role\":0,\"host\":\"127.0.0.1\",\"port\":6379,\"pwd\":\"\",\"conn_timeout\":10,\"min_conn_count\":20,\"max_conn_count\":100},{\"key\":1,\"role\":1,\"host\":\"127.0.0.1\",\"port\":6379,\"pwd\":\"\",\"conn_timeout\":10,\"min_conn_count\":20,\"max_conn_count\":100}]]}";
...
void* test_set(void *t) {
	int idx = 0;
	do {
		if (client.set("test_01", MyRedis::int2str(++idx), -1, MyRedis::RedisClient::SET_MODE_NX)) {
